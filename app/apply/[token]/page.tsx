...
export default function ApplyPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  const { register, handleSubmit, trigger, formState: { errors, isSubmitting } } = useForm<Values>({ resolver: zodResolver(schema), defaultValues: { experience: 0, source: "Careers Page" } });
